<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModInsumo.aspx.cs" Inherits="Default4" %>
						...
						<!-- Post -->
							<section class="post">
                                ...
                                <asp:Button ID="btnAceptar" runat="server" Text="Agregar" PostBackUrl="~/Insumo.aspx" OnClick="btnAceptar_Click"   />
                                 ...
                                 <asp:Button ID="btnEliminar" runat="server" Text="Eliminar"  PostBackUrl="~/EliInsumo.aspx" OnClick="btnEliminar_Click"/>
