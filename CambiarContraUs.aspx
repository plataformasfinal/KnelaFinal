<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CambiarContraUs.aspx.cs" Inherits="CambiarContraUs" %>
			...
			<div id="wrapper">
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
                            ...
                            <li class="active"><a href="CambiarContraUs.aspx">Cambiar Contraseña</a></li>
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Post -->
							<section class="post">
                                <div align="center"><img src="images/pic03.jpg" width="500" height="260"/></a></div>
								<header class="major">
							...
							<br />
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Volver" PostBackUrl="~/Default.aspx" OnClick="Button1_Click" />
                                    <br />
