<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EliInsumo.aspx.cs" Inherits="Default3" %>
					...
					<div id="main">
						...
						<!-- Post -->
							<section class="post">
                                ...
                                <asp:TextBox ID="txtIdInsumo" runat="server"></asp:TextBox><br />
                                 
                                
								<asp:Button ID="btnEliminar" runat="server" Text="Eliminar"  OnClick="btnEliminar_Click" />	
                                <asp:Button ID="btnAceptar" runat="server" Text="Agregar" PostBackUrl="~/Insumo.aspx" OnClick="btnAceptar_Click"   />
									
                                 <asp:Button ID="btnModificar" runat="server" Text="Modificar"  PostBackUrl="~/ModInsumo.aspx" OnClick="btnModificar_Click"/>
